...
import com.shash.ytadskipper.service.YtAdSkipperAccessibilityService
    ...
    class SettingsFragment : PreferenceFragmentCompat(),
        ...
        private fun isYoutubeServiceEnabled(): Boolean {
            return isAccessibilityServiceEnabled(
                context,
                YtAdSkipperAccessibilityService::class.java
            )
        }
        ...
        override fun onSharedPreferenceChanged(
            ...
            val isServiceEnabled =
                isAccessibilityServiceEnabled(context, YtAdSkipperAccessibilityService::class.java)
